      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="w-full">
          ...
          <div className="grid grid-cols-3 mt-8 place-items-center gap-8 bg-linear-to-br from-emerald-900 to-cyan-700 py-8 rounded-4xl">
            <div className="overflow-hidden border-2 border-purple-700 w-14 h-14 md:h-16 md:w-16 lg:w-24 lg:h-24 rounded-full">
              <img src="/1.svg" />
            </div>
            <div className="overflow-hidden border-2 border-purple-700 w-14 h-14 md:h-16 md:w-16 lg:w-24 lg:h-24 rounded-full col-start-3">
              <img src="/2.svg" />
            </div>
            <div className="overflow-hidden border-2 border-purple-700 w-14 h-14 md:h-16 md:w-16 lg:w-24 lg:h-24 rounded-full col-start-2">
              <img src="/3.svg" />
            </div>
            <div className="overflow-hidden border-2 border-purple-700 w-14 h-14 md:h-16 md:w-16 lg:w-24 lg:h-24 rounded-full col-start-1">
              <img src="/4.svg" />
            </div>
            <div className="overflow-hidden border-2 border-purple-700 w-14 h-14 md:h-16 md:w-16 lg:w-24 lg:h-24 rounded-full col-start-3">
              <img src="/5.svg" />
